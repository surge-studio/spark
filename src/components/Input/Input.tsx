  ...
  ({ className, type, ...props }, ref) => (
    <input
      ...
      className={cn(
        ...
        'focus-visible:outline-none focus-visible:ring-2 focus:ring-primary-100 focus:border-primary-600 dark:focus:ring-primary-900 dark:focus:border-primary-500',
        className
      )}
      ref={ref}
      {...props}
