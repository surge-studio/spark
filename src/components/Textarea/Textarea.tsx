...
const Textarea = forwardRef<HTMLTextAreaElement, TextareaProps>(
  ({ className, ...props }, ref) => (
    <textarea
      className={cn(
        'flex transition h-20 w-full rounded bg-transparent px-3 py-2 text-base sm:text-sm placeholder:text-gray-500 disabled:cursor-not-allowed disabled:opacity-50',
